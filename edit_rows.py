...
def update_spreadsheet_data(rows, range):
    ...
    all_rows = service.spreadsheets().values().update(
        spreadsheetId=SPREADSHEET_ID, range=range, valueInputOption='RAW', body=body
        ).execute()
    return all_rows

update_spreadsheet_data(['Yash Jhav', 'yashjadhav1502@gmail.com', '223'], f'{SHEET_NAME}!A4:C4')
